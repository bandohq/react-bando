        ...
        >
          <div className="container w-container">
            <a href="/" className="brand w-nav-brand">
              <img src="images/bando_full_green.png" loading="lazy" alt="" className="image-2" />
            </a>
            <nav role="navigation" className="w-nav-menu">
              <a href="#email-2" className="button w-button">
                Empieza Hoy
              </a>
            </nav>
          </div>
            ...
            <div className="w-layout-blockcontainer container-8 w-container">
              <div className="div-block horizontal">
                ...
                <div className="div-block-4">
                  <div>
                    <img
                      src="images/Abraham-Cobos.jpeg"
                      loading="lazy"
                      sizes="(max-width: 479px) 100vw, (max-width: 767px) 35vw, (max-width: 991px) 22vw, 200px"
                      alt=""
                      className="image-3"
                    />
                    ...
                    <div className="div-block-9">
                      <a
                        href="https://www.linkedin.com/in/abrahamcobos/"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="w-inline-block"
                      >
                        <img src="images/Vector_1.png" loading="lazy" alt="" className="image-74" />
                      </a>
                      <a
                        href="https://twitter.com/abrahamcr"
                        target="_blank"
                        className="w-inline-block"
                        rel="noreferrer"
                      >
                        <img src="images/Vector-1.png" loading="lazy" alt="" className="image-75" />
                      </a>
                    </div>
                  </div>
                  <div>
                    <img src="images/Luis-Gabriel.jpeg" loading="lazy" alt="" className="image-3" />
                    <h1 className="heading-3">Luis Gabriel</h1>
                    <p className="paragraph-5 left center-mobile">Co-founder: Tech</p>
                    <div className="div-block-9">
                      <a
                        href="https://www.linkedin.com/in/luis-gabriel-bb154691/"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="w-inline-block"
                      >
                  ...
                  <div>
                    <img
                      src="images/Eduardo-Rios.jpeg"
                      loading="lazy"
                      id="w-node-ea006ffe-c4d0-b3e8-9838-096c833caa3a-bee46153"
                      sizes="(max-width: 479px) 100vw, (max-width: 767px) 35vw, (max-width: 991px) 22vw, 200px"
                      alt=""
                      className="image-3"
                    />
                    ...
                    <div className="div-block-9">
                      <a
                        href="https://www.linkedin.com/in/eduardo-g-ba5569198/"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="w-inline-block"
                      >
                      ...
                      <a
                        href="https://twitter.com/Lalocripto"
                        target="_blank"
                        className="w-inline-block"
                        rel="noreferrer"
                      >
